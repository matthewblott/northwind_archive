namespace northwind.domain
{
  ...
  public class Context : DbContext, IContext, IReports
  {
    ...
    // Reports
    public virtual DbSet<RecentOrder> RecentOrders { get; set; }
    public virtual DbSet<RecentOrderItem> RecentOrderItems { get; set; }
